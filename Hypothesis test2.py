...
feature = 'off_peak_peak_var_mean_diff'
...
alpha = 0.05
if p_value < alpha:
    print("There is a significant difference in seasonal price changes between churned and non-churned customers.")
else:
    print("There is no significant difference in seasonal price changes between churned and non-churned customers.")
